...
class AppColors{
  ...
  static final Color mainColor = const Color(0xFF89faf0);
  ...
  static final Color buttonBackgroundColor = const Color(0xFFffffff);
  static final Color titleColor = const Color(0xFFa9a29f);
  static final Color mainBlackColor = const Color(0xFF5c524f);
